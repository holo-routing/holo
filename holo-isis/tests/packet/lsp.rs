...
use holo_isis::packet::consts::FloodingAlgo;
...
use holo_isis::packet::subtlvs::neighbor::{
    AdjSidFlags, AdjSidStlv, AdminGroupStlv, ExtAdminGroupStlv,
    Ipv4InterfaceAddrStlv, Ipv4NeighborAddrStlv, MaxLinkBwStlv,
    MaxResvLinkBwStlv, MinMaxUniLinkDelayFlags, MinMaxUniLinkDelayStlv,
    TeDefaultMetricStlv, UniAvailBwStlv, UniDelayVariationStlv,
    UniLinkDelayFlags, UniLinkDelayStlv, UniLinkLossFlags, UniLinkLossStlv,
    UniResidualBwStlv, UniUtilBwStlv, UnreservedBwStlv,
};
...
static LSP1: Lazy<(Vec<u8>, Option<&Key>, Pdu)> = Lazy::new(|| {
    (
        vec![
            0x83, 0x1b, 0x01, 0x00, 0x12, 0x01, 0x00, 0x00, 0x01, 0xa1, 0x04,
            0x92, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x04, 0x62, 0x63, 0x01, 0x81, 0x01, 0xcc, 0xf2, 0x33, 0x01,
            ...
            0x00, 0x16, 0x95, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x03, 0x00,
            0x00, 0x0a, 0x8a, 0x03, 0x04, 0x00, 0x00, 0x00, 0x0f, 0x0e, 0x04,
