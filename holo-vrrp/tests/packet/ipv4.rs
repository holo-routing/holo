...
fn valid_pkt_data() -> [u8; 20] {
    [
        0x45, 0x00, 0x00, 0x34, 0x6c, 0xb8, 0x40, 0x00, 0x33, 0x06, 0xfe, 0x74,
        0xd0, 0x73, 0xe7, 0x6a, 0xc0, 0xa8, 0x64, 0x10,
    ]
}

#[test]
fn encode_valid_pkt() {
    let pkt_wrapped = Ipv4Packet::decode(&valid_pkt_data());
...
fn test_invalid_checksum() {
    ...
    let pkt = Ipv4Packet::decode(data);
    assert_eq!(pkt, Err(DecodeError::ChecksumError));
}
