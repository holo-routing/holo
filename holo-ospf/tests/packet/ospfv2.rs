    ...
    Lazy::new(|| {
        (
            vec![
                ...
                0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x50, 0xd3,
                0x00, 0x0a, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x03,
                0x00, 0x13, 0x00, 0x04, 0x00, 0x01, 0x12, 0x34, 0x00, 0x13,
                0x00, 0x04, 0x01, 0x02, 0x43, 0x21, 0x00, 0x14, 0x00, 0x08,
                0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x56, 0x78,
            ],
            None,
            Packet::Hello(Hello {
                hdr: PacketHdr {
    ...
    Lazy::new(|| {
        (
            vec![
                ...
                0x00, 0x10, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x03,
                0x00, 0x13, 0x00, 0x04, 0x00, 0x01, 0x12, 0x34, 0x00, 0x13,
                0x00, 0x04, 0x01, 0x02, 0x43, 0x21, 0x00, 0x14, 0x00, 0x08,
                0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x56, 0x78, 0x00, 0x02,
                0x00, 0x14, 0x32, 0x45, 0xd0, 0x14, 0x7b, 0x81, 0xa1, 0xdd,
                0xe3, 0xfd, 0xf7, 0xc6, 0xe2, 0xe2, 0xad, 0x43, 0x1c, 0x4e,
                0x16, 0xc6,
            ],
            Some((
                Key::new(1, CryptoAlgo::Md5, "HOLO".as_bytes().to_vec()),
...
static HELLO1_HMAC_SHA1_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x1f, 0x6e, 0x8e, 0x02, 0x18, 0x4c, 0x00, 0x00, 0x00, 0x11, 0x00,
            0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x00, 0x13, 0x00, 0x04,
            0x00, 0x01, 0x12, 0x34, 0x00, 0x13, 0x00, 0x04, 0x01, 0x02, 0x43,
            0x21, 0x00, 0x14, 0x00, 0x08, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x56, 0x78, 0x00, 0x02, 0x00, 0x18, 0x32, 0x45, 0xd0, 0x14, 0xe4,
            0xca, 0xe9, 0xd8, 0xd2, 0xb1, 0x0d, 0x12, 0xed, 0x5e, 0x5d, 0xe2,
            0xf6, 0x4e, 0x02, 0xcc, 0x6c, 0x92, 0x14, 0x86,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha1, "HOLO".as_bytes().to_vec()),
            843436052,
...
static HELLO1_HMAC_SHA256_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x78, 0x4a, 0xef, 0xa7, 0x15, 0xd7, 0x5c, 0x00, 0x00, 0x00, 0x14,
            ...
            0x00, 0x56, 0x78, 0x00, 0x02, 0x00, 0x24, 0x32, 0x45, 0xd0, 0x14,
            0xce, 0xb1, 0x91, 0xef, 0x8f, 0x15, 0x68, 0x5d, 0xa1, 0xbd, 0x43,
            0x5a, 0xdb, 0xe8, 0x54, 0x90, 0xdc, 0xeb, 0xb1, 0xef, 0x70, 0xa6,
            0x06, 0x50, 0xce, 0x40, 0x2b, 0x0b, 0x25, 0x2a, 0x16, 0xba,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha256, "HOLO".as_bytes().to_vec()),
            843436052,
...
static HELLO1_HMAC_SHA384_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x17, 0x00, 0x00, 0x00, 0x18, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00,
            0x00, 0x03, 0x00, 0x13, 0x00, 0x04, 0x00, 0x01, 0x12, 0x34, 0x00,
            0x13, 0x00, 0x04, 0x01, 0x02, 0x43, 0x21, 0x00, 0x14, 0x00, 0x08,
            0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x56, 0x78, 0x00, 0x02, 0x00,
            0x34, 0x32, 0x45, 0xd0, 0x14, 0x87, 0x46, 0x63, 0xd5, 0xb5, 0xe0,
            0xba, 0xe4, 0xeb, 0xe0, 0xe5, 0x03, 0xc1, 0x5f, 0xa9, 0x05, 0x81,
            0xb5, 0xac, 0x18, 0x75, 0xe2, 0x6b, 0x6f, 0x7a, 0x12, 0x00, 0x74,
            0x47, 0x4e, 0x5c, 0x72, 0x59, 0x75, 0x0f, 0xe9, 0xfa, 0xee, 0x15,
            0xb8, 0xf3, 0x2e, 0x00, 0x3d, 0xe3, 0xee, 0x23, 0xc4,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha384, "HOLO".as_bytes().to_vec()),
            843436052,
...
static HELLO1_HMAC_SHA512_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0xcd, 0x8c, 0xc1, 0x06, 0xcc, 0x92, 0x00, 0x00, 0x00, 0x1c, 0x00,
            0x01, 0x00, 0x04, 0x00, 0x00, 0x00, 0x03, 0x00, 0x13, 0x00, 0x04,
            0x00, 0x01, 0x12, 0x34, 0x00, 0x13, 0x00, 0x04, 0x01, 0x02, 0x43,
            0x21, 0x00, 0x14, 0x00, 0x08, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x56, 0x78, 0x00, 0x02, 0x00, 0x44, 0x32, 0x45, 0xd0, 0x14, 0x01,
            0x00, 0x95, 0xaa, 0xfa, 0xf4, 0x99, 0xd3, 0x75, 0xdd, 0x76, 0x09,
            0x1d, 0x5e, 0xa1, 0x8c, 0x7c, 0x18, 0x34, 0xf9, 0x96, 0x77, 0x7b,
            0x84, 0xa5, 0xda, 0x96, 0x92, 0x85, 0x99, 0xaf, 0xa0, 0x20, 0x6f,
            0x8b, 0x81, 0x57, 0xbd, 0x6d, 0xc5, 0xd6, 0x0b, 0x09, 0xdf, 0xdf,
            0x67, 0xe5, 0xef, 0xcd, 0x0f, 0xc2, 0xfe, 0x3c, 0xbf, 0x02, 0xb3,
            0xaf, 0x72, 0xec, 0x5d, 0xf0, 0x3b, 0x75, 0x3d,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha512, "HOLO".as_bytes().to_vec()),
            843436052,
