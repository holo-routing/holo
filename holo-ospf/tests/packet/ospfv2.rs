    ...
    Lazy::new(|| {
        (
            vec![
                ...
                0x00, 0x02, 0x00, 0x14, 0x32, 0x45, 0xd0, 0x14, 0xb7, 0x72,
                0x3e, 0x31, 0xf1, 0x26, 0x05, 0x02, 0x1e, 0xcb, 0xe7, 0x5f,
                0x2b, 0xcd, 0x92, 0xcc,
            ],
            Some((
                Key::new(1, CryptoAlgo::Md5, "HOLO".as_bytes().to_vec()),
...
static HELLO1_HMAC_SHA1_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x32, 0x45, 0xd0, 0x14, 0x2b, 0x73, 0x90, 0xa6, 0x36, 0x1a, 0xae,
            0x92, 0x32, 0x65, 0x58, 0xc4, 0x07, 0xcb, 0xe3, 0x9c, 0x9c, 0xc8,
            0x2c, 0xea,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha1, "HOLO".as_bytes().to_vec()),
...
static HELLO1_HMAC_SHA256_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x24, 0x32, 0x45, 0xd0, 0x14, 0x93, 0x82, 0x90, 0x26, 0x71, 0x8b,
            0xb3, 0x8d, 0xc7, 0x20, 0x82, 0xd5, 0x19, 0x39, 0xc9, 0xbf, 0x38,
            0x2e, 0x54, 0xa8, 0x67, 0xa8, 0xe9, 0x11, 0xa7, 0xa1, 0x5b, 0x8b,
            0x9f, 0x0d, 0xe0, 0xe3,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha256, "HOLO".as_bytes().to_vec()),
...
static HELLO1_HMAC_SHA384_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x00, 0x03, 0x00, 0x02, 0x00, 0x34, 0x32, 0x45, 0xd0, 0x14, 0x37,
            0x86, 0xa7, 0x90, 0x3e, 0xba, 0x0b, 0x37, 0x65, 0x6f, 0xcf, 0x2e,
            0x2c, 0x3b, 0x7c, 0x08, 0x5d, 0xfd, 0x45, 0x8a, 0x6a, 0xea, 0xfa,
            0x80, 0x5e, 0xdb, 0xa2, 0x5b, 0x02, 0xb4, 0xa4, 0x4b, 0x27, 0x3c,
            0xf9, 0xe5, 0xd1, 0x8d, 0x22, 0x3c, 0xf7, 0x02, 0xd6, 0x17, 0x58,
            0xe0, 0x11, 0x6c,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha384, "HOLO".as_bytes().to_vec()),
...
static HELLO1_HMAC_SHA512_LLS: Lazy<(
    ...
    (
        vec![
            ...
            0x32, 0x45, 0xd0, 0x14, 0xa8, 0x19, 0xbc, 0xc0, 0x70, 0x34, 0xf9,
            0x5c, 0x76, 0xc9, 0x34, 0xa8, 0xe2, 0x76, 0xd5, 0x1d, 0x36, 0x84,
            0x6e, 0xb4, 0xd3, 0x8b, 0x6b, 0x66, 0x75, 0xea, 0xeb, 0x59, 0xd1,
            0x23, 0x47, 0x6c, 0x6a, 0xe5, 0xff, 0x74, 0xa4, 0x47, 0x0e, 0xb8,
            0xfa, 0x1e, 0x59, 0x36, 0x3a, 0x54, 0xfb, 0x69, 0x93, 0xec, 0x5d,
            0x4a, 0x4a, 0x9b, 0x20, 0xde, 0x1c, 0x5c, 0x4a, 0xa4, 0x41, 0xab,
            0x20, 0x19,
        ],
        Some((
            Key::new(1, CryptoAlgo::HmacSha512, "HOLO".as_bytes().to_vec()),
