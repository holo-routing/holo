...
impl std::fmt::Display for Protocol {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Protocol::MLDV1 => write!(f, "mldv1"),
            Protocol::MLDV2 => write!(f, "mldv2"),
...
impl FromStr for Protocol {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_ref() {
            ...
            "ldp" => Ok(Protocol::LDP),
            "mldv1" => Ok(Protocol::MLDV1),
            "mldv2" => Ok(Protocol::MLDV2),
...
impl ToYang for Protocol {
    fn to_yang(&self) -> Cow<'static, str> {
        match self {
            ...
            Protocol::IGMP => "ietf-igmp-mld:igmp".into(),
            Protocol::ISIS => "ietf-isis:isis".into(),
            Protocol::LDP => "ietf-mpls-ldp:mpls-ldp".into(),
            Protocol::MLDV1 => "ietf-igmp-mld:mldv1".into(),
            Protocol::MLDV2 => "ietf-igmp-mld:mldv2".into(),
...
impl TryFromYang for Protocol {
    fn try_from_yang(identity: &str) -> Option<Protocol> {
        match identity {
            ...
            "ietf-igmp-mld:igmp" => Some(Protocol::IGMP),
            "ietf-mpls-ldp:mpls-ldp" => Some(Protocol::LDP),
            "ietf-igmp-mld:mldv1" => Some(Protocol::MLDV1),
            "ietf-igmp-mld:mldv2" => Some(Protocol::MLDV2),
